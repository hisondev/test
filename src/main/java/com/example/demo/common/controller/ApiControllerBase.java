...
************************import com.test.boot02.common.data.DataModel; 를
MainControllerBase를 상속 받아 MainController를 만드는 개발자가
DataModel를 상속받아 만들어잔 DataModel로 교체할수 있는 방법이 있을까?

해결되면 DataWrapper등에도 적용가능!!
 */
...
public class ApiControllerBase {
    ...
    @Autowired
    private ApplicationContext applicationContext; // Spring의 ApplicationContext를 주입
    ...
    public DataWrapper handlePost(@RequestBody DataWrapper dw, HttpServletRequest req) {
        System.out.println("### This is a MainControllerBase 1 ###");
        DataWrapper result = handleRequest(dw, req);
        return result;
    }
    ...
    private DataWrapper handleRequest(DataWrapper dw, HttpServletRequest req) {
        System.out.println("### This is a MainControllerBase 2 ###");
    ...
    protected DataWrapper handleError(Exception e) {
        System.out.println("### This is a MainControllerBase 3 ###");
        e.printStackTrace();
